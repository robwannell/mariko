...
class MetatagsControllerTest < ActionController::TestCase
  ...
  test "should create metatag" do
    assert_difference('Metatag.count') do
      post :create, metatag: { description: @metatag.description, keywords: @metatag.keywords, pagetitle: @metatag.pagetitle }
    end
  ...
  test "should update metatag" do
    patch :update, id: @metatag, metatag: { description: @metatag.description, keywords: @metatag.keywords, pagetitle: @metatag.pagetitle }
    assert_redirected_to metatag_path(assigns(:metatag))
  end
